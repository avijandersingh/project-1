...
<!-- Sidebar -->
<div id="application-sidebar-brand" class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform fixed top-0 left-0 bottom-0 z-[60] w-64 bg-blue-700 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 {isOpen?'open':'hidden'}"  style="{isOpen?'--tw-translate-x: 0px;':''}"    aria-overlay="true" tabindex="-1">
    <div class="px-6">
